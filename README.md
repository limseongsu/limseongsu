...
<img src = ![이력서사진](https://github.com/limseongsu/limseongsu/assets/79133729/d58b3797-a1f0-4048-bc9b-caa3690c0eda) width="300" height="350">
...
### 뉴스토마스 글로벌ver. (기여도 100%)
- 주요역할 : 글로벌 ver. 점유인증 시스템 등 메인기능 개발

##### 1. SMS 점유 인증 기능 구현 추가
-  Twilio 문자인증 시스템을 통한 본인인증 서비스 구현
- 국제번호 Library를 가져와 Custom을 하여  통한 글로벌 서비스에 맞게 수정하여 구현 

##### 2. 반응형 사이즈 대응
- 기존 국내버전과 텍스트 문자열 길이가 용이하여 생기는 overFlow이슈 대응 완료
